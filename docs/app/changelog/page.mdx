...
* **Rich Text Formatting Documentation**: Complete guide for handling JSX elements within translations
  ...
  * Best practices for maintaining translatable text with embedded JSX
  * Support for both next-intl and i18next Trans component approaches

### 🔄 Changed

* Enhanced README with pluralization and rich text examples
* Updated documentation site with detailed usage instructions
* Improved examples page with real-world pluralization and rich text scenarios
...
**Documentation:**
- See [Examples Page](/examples) for comprehensive pluralization and rich text patterns
